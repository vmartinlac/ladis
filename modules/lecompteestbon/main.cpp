...
public:
    ...
    void solve(const std::vector<int>& numbers, int target, std::chrono::milliseconds time_budget, int num_solutions)
    {
...
{
    const std::vector<int> numbers{100, 2, 75, 3, 1, 10};
    const int target = 578;

    GraphBasedSolver solver;

    solver.solve(numbers, target, std::chrono::milliseconds(1000), 2);
